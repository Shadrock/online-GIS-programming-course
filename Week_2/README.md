...
By following this code-along, you’ll learn to navigate geographic shapefiles in a Jupyter Notebook. you’ll be uploading data from DC’s open data portal, and then concatenating datasets using a Colab notebook. We'll conduct some basic analysis on the datasets and ultimately, display a basic map, and create a new `.shp` file.
